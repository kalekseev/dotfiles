 ...
 */
static char font[] = "FuraCode Nerd Font:pixelsize=15:antialias=true:autohint=false";
...
static const char *colorname[] = {
	"#315575",		/* 0: ANSI Color 0 */
	"#e42c31",		/* 1: ANSI Color 1 */
	"#6bff63",		/* 2: ANSI Color 2 */
	"#fc9531",		/* 3: ANSI Color 3 */
	"#267dce",		/* 4: ANSI Color 4 */
	"#ee1e88",		/* 5: ANSI Color 5 */
	"#5ddefd",		/* 6: ANSI Color 6 */
	"#ffffff",		/* 7: ANSI Color 7 */
	"#315ea6",		/* 8: ANSI Color 8 */
	"#bd3612",		/* 9: ANSI Color 9 */
	"#465a61",		/* 10: ANSI Color 10 */
	"#52676f",		/* 11: ANSI Color 11 */
	"#708183",		/* 12: ANSI Color 12 */
	"#5856b9",		/* 13: ANSI Color 13 */
	"#81908f",		/* 14: ANSI Color 14 */
	"#fcf4dc",		/* 15: ANSI Color 15 */
	[255] = 0,
	[256] = "#02232e",		/* 256: Background */
	[257] = "#bfd9db",		/* 257: Foreground */
	...
	/* No support for bold coloring; would be #adbbbb. */
};
